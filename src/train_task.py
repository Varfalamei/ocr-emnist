...
from models import CRNN_v2
from utils import valid_epoch, train_epoch
...
def train():
    ...
    for epoch in range(1, CONFIG.epochs + 1):
        ...
        acc, _ = valid_epoch(model=model, criterion=criterion, val_loader=val_loader, config=CONFIG)
        if acc > current_acc:
